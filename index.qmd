...
::: {.mt-4 .p-3 .bg-light .rounded style="border-left: 4px solid #003366;"}
**Core Topics Include:** Computational fluid dynamics (CFD), Computational mechanics, Digital twins, High-fidelity simulations, Reduced-order modeling, Robotics, Scientific machine learning.
...
::: mt-4
<a href="https://forms.gle/SKYbnJTSXGxyU7Ec7" class="btn btn-primary btn-lg px-5 py-3 shadow-sm btn-hover-lift" style="border-radius: 50px; font-weight: 500; font-size: 1.1rem;">Register Now <i class="bi bi-arrow-right ms-2"></i></a>
:::
::::
::::::::::
:::::::::::
